...
describe('PairNamer', () => {
  ...
  describe('#pairName', () => {
    ...
    it('concatenation', async () => {
      expect(await pairName('DAI Stable Coin', 'MKR Token', 'danaswap V2 Liquidity Provider Share for ', '.')).to.eq(
        'danaswap V2 Liquidity Provider Share for DAI Stable Coin:MKR Token.'
      )
    })
  })
