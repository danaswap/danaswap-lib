...
describe('PairNamer', () => {
  ...
  describe('#pairName', () => {
    ...
    it('concatenation', async () => {
      expect(await pairName('DAI Stable Coin', 'MKR Token', 'Eliteswap V2 Liquidity Provider Share for ', '.')).to.eq(
        'Eliteswap V2 Liquidity Provider Share for DAI Stable Coin:MKR Token.'
      )
    })
  })
